...
namespace StartOfEnding.Services
{
    public class TelegramBotHelper
    {
        ...
        private const string text_5Start = "/start";
        ...
        public TelegramBotHelper(string token, SqliteContext sqliteContext)
        {
            this._token = token;
        ...
        private void processUpdate(Telegram.Bot.Types.Update update)
        {
            ...
            switch (update.Type)
            {
                case Telegram.Bot.Types.Enums.UpdateType.Message:
                    ...
                    {
                        case text_5Start:
                            _client.SendTextMessageAsync(update.Message.Chat.Id, "Привіт", replyMarkup: GetButtons());
                            break;
                        ...
                        default:
                            ...
                            _client.SendTextMessageAsync(update.Message.Chat.Id, "Q", replyMarkup: GetButtons());
                            break;
                    }
                    break;
